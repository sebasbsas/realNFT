      ...
      abi: [
        {
          ...
          interface_name: "contracts::your_collectible::IYourCollectible",
        },
        {
          type: "struct",
        ...
        {
          type: "interface",
          name: "contracts::your_collectible::IYourCollectible",
          items: [
            {
              type: "function",
              name: "mint_item",
        ...
        {
          type: "event",
          name: "contracts::your_collectible::YourCollectible::Event",
          kind: "enum",
          variants: [
            {
              name: "ERC721Event",
  ...
  mainnet: {
    ...
    QuestlyNFTStandard: {
      ...
      abi: [
        {
          type: "impl",
          name: "QuestlyNFTStandardImpl",
          interface_name:
            "contracts::questly_nft_standard::IQuestlyNFTStandard",
        },
        {
          type: "struct",
          name: "core::byte_array::ByteArray",
        ...
        {
          type: "interface",
          name: "contracts::questly_nft_standard::IQuestlyNFTStandard",
          items: [
            {
              type: "function",
              name: "mint_item",
        ...
        {
          type: "event",
          name: "contracts::questly_nft_standard::QuestlyNFTStandard::Event",
          kind: "enum",
          variants: [
            {
              name: "ERC721Event",
      ...
      classHash:
        "0x3b549f2bac5ded9f5e306690f77c134160e50e5d6d899193f3d929716e335af",
    },
    MinimalNFT: {
      address:
        "0x755640286548577c332cb05913db474a809e59a29656c9d0e7ed7285dac8e88",
      abi: [
        {
          type: "function",
          name: "mint",
